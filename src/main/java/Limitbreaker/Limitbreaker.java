package Limitbreaker;

import Limitbreaker.chr.chr_lb;
import Limitbreaker.vars.lb_card_magic;
...
import Limitbreaker.relics.AbstractEasyRelic;

import java.nio.charset.StandardCharsets;

import static Limitbreaker.chr.chr_lb.characterStrings;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class Limitbreaker implements
        EditCardsSubscriber,
    ...
    private static String modID = "limitbreaker";
    ...
    public Limitbreaker() {
        ...
        BaseMod.addColor(chr_lb.Enums.LIMITBREAKER_COLOUR, lbColour, lbColour, lbColour,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new chr_lb(characterStrings.NAMES[1], chr_lb.Enums.LIMITBREAKER),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, chr_lb.Enums.LIMITBREAKER);
    }
    ...
    public void receiveEditCards() {
        BaseMod.addDynamicVariable(new lb_card_magic());
        new AutoAdd(modID)
                .packageFilter("Limitbreaker.cards")
                .setDefaultSeen(true)
                .cards();
    }

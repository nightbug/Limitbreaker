...
abstract class abs_lb_card_dm extends abs_lb_card {
    private float rotationTimer = getRotationTimeNeeded();
    private int previewIndex;
    protected ArrayList<AbstractCard> cardToPreview = new ArrayList<>();
    public abs_lb_card_dm(CardInfo cardInfo, boolean upgradesDescription) { super(chr_lb.Enums.LIMITBREAKER_COLOUR, cardInfo.cardName, cardInfo.cardCost, cardInfo.cardType, cardInfo.cardTarget, cardInfo.cardRarity, upgradesDescription); }

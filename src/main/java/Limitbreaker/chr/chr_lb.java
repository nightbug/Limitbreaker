...
import Limitbreaker.cards.bas.Defend;
import Limitbreaker.cards.bas.Strike;
import Limitbreaker.relics.TodoItem;
import Limitbreaker.util.BetterSpriterAnimation;
...
import static Limitbreaker.Limitbreaker.*;
import static Limitbreaker.util.actionShortcuts.p;

public class chr_lb extends CustomPlayer {

    public static class Enums {
        @SpireEnum
        public static PlayerClass LIMITBREAKER;
        @SpireEnum(name = "LIMITBREAKER_COLOUR")
        public static AbstractCard.CardColor LIMITBREAKER_COLOUR;
        @SpireEnum(name = "LIMITBREAKER_COLOUR")
    ...
    private static final String ID = makeID(chr_lb.class.getSimpleName());
    public static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    private static final String[] NAMES = characterStrings.NAMES;
    private static final String[] TEXT = characterStrings.TEXT;


    public chr_lb(String name, PlayerClass setClass) {
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.LIMITBREAKER_COLOUR;
    }
    ...
    public AbstractPlayer newInstance() {
        return new chr_lb(name, chosenClass);
    }
    ...
    public static void runAnimation(String anim) {
        if (p() instanceof chr_lb) { ((chr_lb) p()).runAnim(anim); }
    }
